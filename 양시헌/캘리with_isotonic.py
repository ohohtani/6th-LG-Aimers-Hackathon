...
# 🔹 10. 캘리브레이션 적용 (isotonic 사용)
print("🔄 캘리브레이션 적용 중 (isotonic)...")

calibrator = CalibratedClassifierCV(base_estimator=final_model, method='isotonic', cv='prefit')
...
# 🔹 13. 최종 CSV 파일 저장
submission_file_path = "cat_after_isotonic.csv"
